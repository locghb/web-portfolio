...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
      ...
      <section
        id="about"
        className="container mx-auto px-4 py-20 text-center scroll-mt-24"
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-portfolio-text mb-8 leading-relaxed">
            I am{" "}
            <span className="font-semibold portfolio-accent">
              Phạm Nguyễn Thiên Lộc
            </span>
            , I specialize in creating clean, efficient, and user-friendly
            digital experiences.
          </p>
          <div className="flex gap-4 justify-center">
            <Button
              size="lg"
              className="bg-[var(--portfolio-primary)] hover:bg-[var(--portfolio-primary)]/90"
              asChild
            >
      ...
      <section
        id="skills"
        className="bg-portfolio-light dark:bg-gray-800 py-20 scroll-mt-24"
      >
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16 portfolio-primary">
            Skills & Technologies
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {skills.map((skill, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="hover-lift border-0 shadow-sm dark:bg-gray-700 dark:border-gray-600"
                >
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <CardHeader>
                  ...
                  <CardDescription className="text-portfolio-text">
                    {project.description}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="bg-[var(--portfolio-light)] dark:bg-gray-600 p-3 rounded-lg mb-4">
                    <p className="text-sm text-portfolio-text font-medium">
                      What I learned:
                    </p>
                    <p className="text-sm text-portfolio-text mt-1">
                      {project.learned}
                    </p>
                  </div>
                ...
                <div key={index} className="relative flex items-start mb-12">
                  ...
                  <div className="ml-8 flex-1">
                    <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-sm hover-lift dark:border-gray-600">
                      <p className="text-sm portfolio-accent font-semibold mb-2">
                        {item.date}
                      </p>
                      <h3 className="text-xl font-semibold mb-2 portfolio-primary dark:text-white">
                        {item.title}
                      </h3>
      ...
      <section id="contact" className="py-20 scroll-mt-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6 portfolio-primary">
            Contact me
          </h2>
          <p className="text-xl text-portfolio-text mb-10 max-w-2xl mx-auto">
            I am always ready to chat about projects, collaboration
            opportunities, or simply share ideas.
          </p>
          <div className="flex gap-4 justify-center mb-10">
            <Button
              size="lg"
              className="bg-[var(--portfolio-accent)] hover:transition bg-[var(--portfolio-accent)]/90"
              asChild
            >
              <a href="mailto:thienlocnguyen123@gmail.com">
                <Mail className="w-5 h-5 mr-2" />
                Send email
              </a>
            </Button>
            <Button variant="outline" size="lg" asChild>
              <a href="https://github.com/locghb" target="_blank" rel="noreferrer">
      ...
      <footer className="bg-[var(--portfolio-primary)] text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <p>
            &copy; 2025 Phạm Nguyễn Thiên Lộc. Designed and built by Phạm Nguyễn
            Thiên Lộc.
          </p>
        </div>
      </footer>
